  ...
  return (
    <div className='flex flex-col [perspective:800px]'>
      <div
        ...
        className='group relative grid w-[260px] grid-rows-[200px_120px_40px] rounded-md bg-[#e6e2da] p-4 text-[#1a1818] transition-transform ease-out hover:[transform:rotateX(var(--x-rotation))_rotateY(var(--y-rotation))_scale(1.1)]'
      >
