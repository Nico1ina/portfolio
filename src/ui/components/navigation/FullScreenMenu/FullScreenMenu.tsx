      ...
      >
        <div id='mySidenav' className='font-serif'>
          <section className='text-[#1a1818]'>
            <ul className='fixed inset-0 ml-5 flex text-left justify-center flex-col sans font-serif text-[50px] sm:text-[100px] md:text-[130px] lg:text-[170px] lg:mt-10'>
              ...
              <div className='flex flex-row gap-x-2 items-left justify-left p-5'>
                <li className='visible sm:visible md:invisible lg:invisible'>
                  <a
                    href='https://www.instagram.com/nihaolina/'
                    target='_blank'
                  >
                    <svg
