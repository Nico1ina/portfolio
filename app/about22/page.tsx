    ...
    <>
      <div className='flex flex-col'>
        ...
        <img
          ...
          alt=''
        />
        <div className='mt-3 md:mt-10 lg:mt-10 ml-10 md:ml-20 lg:ml-20 z-30 font-mono text-3xl text-[#1a1818]'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex'>
            <div className='flex w-0 md:w-1/2' />
            <div className='flex gap-2 font-mono py-4'>
