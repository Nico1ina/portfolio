        ...
        <div className="flex flex-col">
          ...
          <div className="flex">
            ...
            <div className="flex gap-2 font-mono pt-4">
              ...
              <button className="group relative inline-flex items-center overflow-hidden rounded-full border border-[#1a1818] px-12 py-3 text-lg text-[#1a1818] hover:bg-gray-50 hover:text-white">
